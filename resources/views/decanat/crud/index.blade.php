...
@section('content')
    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
        ...
        <a class="btn btn-primary" href="{{ route('decanat.crud.create', $resource) }}">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="btn-group btn-group-sm">
                                <a class="btn btn-outline-primary" href="{{ route('decanat.crud.edit', [$resource, $item->id]) }}">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form method="POST" action="{{ route('decanat.crud.destroy', [$resource, $item->id]) }}" onsubmit="return confirm('Confirmer la suppression ?')">
                                    @csrf
                                    @method('DELETE')
